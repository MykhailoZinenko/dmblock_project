...
import { Text } from '../../src/engine/nodes/Text.js';
...
const mockTexture = { baseTexture: { gpuTexture: null, gpuSampler: null, width: 256, height: 256 } };
...
describe('Text', () => {
  ...
  it('setFont stores font data as default', () => {
    Text.setFont(mockFont, mockTexture);
    assertEqual(Text._defaultFont, mockFont);
  ...
  it('per-instance font overrides default', () => {
    ...
    const t = new Text('Hello', {}, customFont, mockTexture);
    assertEqual(t._font, customFont);
  });
