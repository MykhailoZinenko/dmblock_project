...
export const UNIT_TARGET_HEIGHT = HEX_SIZE * 2.2;
export const BUILDING_1x1_TARGET_HEIGHT = HEX_SIZE * 2.4;
export const BUILDING_2x2_TARGET_HEIGHT = HEX_SIZE * 3.2;

// HP bar dimensions
export const HP_BAR_WIDTH = 36;
export const HP_BAR_HEIGHT = 4;
export const HP_BAR_Y_OFFSET = HEX_SIZE * 0.55;
